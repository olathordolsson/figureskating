...
export type CategoryId = 'hopp' | 'snurrar' | 'svängar' | 'glidövningar';
...
export const TRICKS: Trick[] = [
  ...
  // ─── SNURRAR – STÅENDE ──────────────────────────────────────────────────────
  {
    ...
    category: 'snurrar',
    subcategory: 'stående-snurr',
    subcategoryLabel: 'Stående snurrar',
    difficulty: 'nybörjare',
    description:
      'Den stående snurren är den grundläggande snurrpositionen i konståkning. Åkaren roterar på ett ben i en upprätt ställning med det fria benet framme eller vid sidan. Det är den första snurren de flesta lär sig och utgör grunden för alla mer avancerade varianter.',
    tips: [
      'Starta snurren från en djup inre bakre kant och dra in armarna snabbt mot kroppen.',
      'Håll vikten centrerad över snurrfotens knapp (den platta mittre delen av klingan).',
    ...
    pitfalls: [
      ...
      'Att snurra på tåspetsen – känn att du är mitt på klingan.',
  ...
  {
    id: 'scratch-spin',
    name: 'Suddgummisnurr (Scratch Spin)',
    ...
    difficulty: 'medel',
    description:
      'Scratch Spin är den snabbaste snurren i konståkning och den klassiska avslutningssnurren. Åkaren drar gradvis in det fria benet och armarna mot kroppen vilket dramatiskt ökar rotationshastigheten (rörelsemängdsmomentets bevarande). Elitåkare kan nå över 300 varv per minut.',
    tips: [
      ...
      'Avsluta snurren med armar och ben utsträckta för ett dramatiskt stopp.',
    ],
    pitfalls: [
      'Att börja dra ihop för tidigt innan du hittat snurraxeln.',
      'Att vandra med snurrcentrumet – du ska stanna på en punkt.',
  ...
  },
  {
    ...
    difficulty: 'medel',
    description:
      'Bakre stående snurr utförs på den icke-dominanta foten (höger fot för vänsterroterande åkare) och är ett av de viktigaste träningsverktygen i konståkning. Kroppspositionen i luften under hopp liknar denna snurrposition, vilket gör den ovärderlig för hopputveckling.',
    tips: [
    ...
    pitfalls: [
      'Att snurra på tåspetsen – ska vara mitt på klingan.',
  ...
  },
  {
    ...
    difficulty: 'avancerad',
    description:
      'Liggande bakåtsnurr är en av de mest ikoniska och vackra elementen i konståkning, starkt förknippad med damernas program. Åkaren snurrar i stående position medan huvud och axlar faller bakåt med ryggraden böjd i en graciös båge. Det fria benets position varierar – sidan, bakåt, eller framåt.',
    tips: [
      'Bygg upp snurrhastigheten innan du lutar bakåt – det är svårt att öka farten i positionen.',
    ...
    pitfalls: [
      'Att ändra snurrcentrum när du lutar bakåt.',
  ...
  },
  {
    ...
    tips: [
      ...
      'Bygg upp snurrhastigheten i liggande bakåtsnurr och gå sedan till Biellmann.',
    ...
    pitfalls: [
      ...
      'Att tappa snurraxeln när man lyfter benet.',
      'Att snurra på tåspetsen – Biellmann kräver extra uppmärksamhet på klingscentrum.',
    ],
  ...
  },
  {
    ...
    difficulty: 'medel',
    description:
      'Attitydsnurren utförs med fria benet i en balettliknande attityd-position: knät böjt och höften utåtroterad, benet hålls åt sidan eller bakåt. Överkroppen lutas något åt sidan och huvudet vrids. Det är en mjukare variant av liggande bakåtsnurr och ett vanligt mellansteg i träningen.',
    tips: [
  ...
  // ─── SNURRAR – SITTSNURR ────────────────────────────────────────────────────
  {
    ...
    category: 'snurrar',
    subcategory: 'sittsnurr',
    subcategoryLabel: 'Sittsnurrar',
    difficulty: 'medel',
    description:
      'Sittsnurren utförs med snurrbenets knä djupt böjt i en sittande position – låret parallellt med isen – och det fria benet sträckt framåt. Det är en styrkeövning för quadricepsen och kräver god balans i en ovanlig position. Djupare sittposition ger mer poäng.',
    tips: [
      ...
      'Bygg upp bensstyrkan med squats och sittsnurrsövningar utanför isen.',
    ],
    pitfalls: [
      'För hög sittposition – komma för tidigt upp ur snurren.',
      'Böjt fritt ben – ska vara rakt.',
      'Att vandra med snurrcentrum – håll dig på en punkt.',
      'Att tippa framåt i sittposition och snurra på tåspetsen.',
    ],
    relatedIds: ['sit-spin-back', 'pancake-spin', 'camel-spin'],
  },
  {
    id: 'sit-spin-back',
    name: 'Bakre sittsnurr',
    ...
    difficulty: 'avancerad',
    description:
      'Bakre sittsnurr utförs på den icke-dominanta foten. Den är landningspositionen för Death Drop och kräver god balans och styrka på den svagare sidan. Betydligt svårare än vanlig sittsnurr.',
    tips: [
      'Öva sittsnurr på höger fot separat innan kombinationen.',
      'Gå in i positionen kontrollerat – inte med stor fart i början.',
    ],
    pitfalls: [
      'Att snurra för högt – kom ner i full sittposition.',
  ...
  },
  {
    ...
    difficulty: 'elit',
    description:
      'Pannkakssnurr är en extrem variant av sittsnurren där fria benet korsas över snurrbenet och överkroppen böjs helt platt framåt tills den nästan vidrör isen – kroppen bildar en platt skiva, som en pannkaka. Kräver extremt rörliga höfter och hamstrings.',
    tips: [
      ...
      'Gå in från en välhållen sittsnurr med god hastighet.',
    ],
    pitfalls: [
      'Att forcera höften ned – risk för skada utan ordentlig uppvärmning.',
      'Att tappa snurraxeln när man böjer sig framåt.',
    ],
    relatedIds: ['sit-spin', 'camel-spin'],
  },
  {
    id: 'cannonball-spin',
    name: 'Kanonbollssnurr',
    ...
    difficulty: 'avancerad',
    description:
      'Kanonbollssnurr är en djup sittsnurr där fria benet viks in (ankle-grip) och bröstet dras mot låret – hela kroppen komprimeras till en tight boll. Skapar en dramatisk acceleration och är en av de mest imponerande sittsnurrvarianterna.',
    tips: [
      'Grip fria benets ankel med samma sidas hand eller båda händerna.',
      'Dra in armar och ben i ett snabbt drag för att accelerera.',
      'Ha god höjd och hastighet i sittsnurren innan du komprimerar.',
    ],
    pitfalls: [
  ...
  // ─── SNURRAR – KAMELSNURR ───────────────────────────────────────────────────
  {
    ...
    category: 'snurrar',
    subcategory: 'kamelsnurr',
    subcategoryLabel: 'Kamelsnurrar',
    difficulty: 'medel',
    description:
      'Kamelsnurren utförs med fria benet sträckt bakåt parallellt med isen, kroppen böjd framåt i en T-form, liknande balettens arabesque. Det är en av de tre grundläggande snurrpositionerna och kräver god balans och styrka i bakre muskulaturen.',
    tips: [
    ...
    pitfalls: [
      ...
      'Att snurra på tåspetsen istället för klingsmitten.',
    ],
    relatedIds: ['flying-camel', 'layover-camel', 'sit-spin'],
  },
  {
    id: 'layover-camel',
    name: 'Liggande kamelsnurr',
    ...
    difficulty: 'avancerad',
    description:
      'Liggande kamelsnurr är en variant där överkroppen roterar uppåt så att kroppen "öppnas" mot taket snarare än mot isen. Det fria benet håller sin arabesque-position, men bröstkorgen och huvudet vänds uppåt. Skapar en elegant och annorlunda siluett.',
    tips: [
      'Starta i vanlig kamelsnurr och rotera gradvis överkroppen uppåt.',
    ...
    pitfalls: [
      ...
      'Att snurra på tåspetsen – positionsförändringen stör snurraxeln.',
    ],
  ...
  },
  {
    ...
    difficulty: 'elit',
    description:
      'Munksnurren är en extrem kamelsnurrvariant där det fria benets klinga grips med en eller båda händerna och dras bakåt mot huvudet medan ryggen böjs dramatiskt bakåt. Kroppen formar en ring eller munkliknande cirkel. Kräver extremt rörlig ryggrad och axlar.',
    tips: [
    ...
    pitfalls: [
      ...
      'Att tappa snurraxeln helt – munksnurren kräver extra stabilt centrum.',
    ],
  ...
  },
  {
    ...
    difficulty: 'avancerad',
    description:
      'Illusionssnurren är en spektakulär kamelsnurrvariant där åkaren rytmiskt gungar överkroppen ned mot isen (fria benet sparkar upp) och upp igen i en vippande rörelse under hela rotationen. Det skapar en optisk illusion av rörelse och är ett av de mest ögonfallande elementen i konståkning.',
    tips: [
      ...
      'Spara energi i snurrcentrumet – kroppen oscillerar men axeln är fast.',
    ],
    pitfalls: [
      'Oregelbunden gungningsrytm – ser hoppigt ut istället för flytande.',
      'Att tappa snurraxeln med vipprörelsen.',
    ],
  ...
  {
    id: 'flying-camel',
    name: 'Flygande kamelsnurr',
    englishName: 'Flying Camel Spin',
    category: 'snurrar',
    subcategory: 'flygande-snurr',
    subcategoryLabel: 'Flygande snurrar',
    difficulty: 'avancerad',
    description:
      'Flygande kamelsnurr startar med ett axelliknande hopp från vänster framre yttre kant. Åkaren lyfter och landar direkt i kamelsnurrpositionen med fria benet bakåt. Det är den mest klassiska av de flygande snurrarna och kombinerar dynamiken i ett hopp med den graciösa kamelsiluetten.',
    tips: [
      ...
      'Öva kamelsnurren separat till perfektion innan du lägger till avhoppet.',
    ],
    pitfalls: [
      'Att landa med för raka benet och "smälla" ned.',
      'Att landa i sittposition istället för kamelposition.',
      'Att vandra med snurrcentrumet efter landningen.',
    ],
    relatedIds: ['camel-spin', 'death-drop', 'butterfly'],
  },
  {
    id: 'flying-sit-spin',
    name: 'Flygande sittsnurr',
    ...
    difficulty: 'avancerad',
    description:
      'Flygande sittsnurr inleds med ett hopp där åkaren antar sittposition i luftens topp – det ser ut som om åkaren sitter i luften. Landningen sker direkt in i sittsnurr. Kraftfullt och visuellt imponerande.',
    tips: [
  ...
  },
  {
    ...
    difficulty: 'avancerad',
    description:
      'Fjärilsspinn är ett spektakulärt tvåfotsavhopps-element. Åkaren tar av från båda fötterna och roterar med kroppen nästan horisontell i luften med benen saxande förbi varandra. Det är lika vanligt som ett koreografiskt element och som ingång till en flygande snurr.',
    tips: [
  ...
  },
  {
    ...
    difficulty: 'elit',
    description:
      'Death Drop (formellt: Flygande öppen Axel-sittsnurr) är ett av konståkningens mest dramatiska element. Avhoppet är axelliknande (framre yttre kant) men avhoppsbenet sparkas aktivt bakåt och upp under flygfasen, vilket skapar en spektakulär splitad siluett i luften. Landningen sker på den icke-dominanta foten direkt in i bakre sittsnurr.',
    tips: [
      ...
      'Bygg upp gradvis: börja med bakre sittsnurr, sedan bakre flygande sittsnurr, sedan Death Drop.',
  ...
  {
    id: 'combination-spin',
    name: 'Kombinationssnurr',
    englishName: 'Combination Spin',
    category: 'snurrar',
    subcategory: 'kombinationssnurr',
    subcategoryLabel: 'Kombinationssnurrar',
    difficulty: 'avancerad',
    description:
      'En kombinationssnurr inkluderar minst två olika grundpositioner (stående, sittande, kamel) i en enda kontinuerlig snurr. Den kan utföras utan fotbyte (CoSp) eller med fotbyte (CCoSp). Fotbytet räknas som ett nivåkrävande element. En komplett kombinationssnurr med alla tre grundpositioner och fotbyte ger maximala nivåpoäng.',
    tips: [
      ...
      'Fotbytet ska göras på ett tydligt sätt med direkt övergång till snurr på andra foten.',
    ],
    pitfalls: [
  ...
  // ─── SVÄNGAR – ETTFOTSSVÄNGAR ────────────────────────────────────────────────
  {
    ...
    tips: [
      'Håll fria foten nära snurrfoten under svängen.',
  ...
  },
  {
    ...
    tips: [
      ...
      'Fria foten hålls mycket nära snurrfoten under hela svängen.',
  ...
  },
  {
    ...
    difficulty: 'avancerad',
    description:
      'En twizzle är en rörlig ettfotssväng med en eller flera fulla rotationer. Till skillnad från snurrar rör sig åkaren över isen under twizzeln. Det är ett signaturteknik i isdans och används även i singelprogram inom stepserier. Flertalet rotationer i hög fart är det ultimata målet.',
    tips: [
    ...
    pitfalls: [
      'Att stanna upp på isen och göra det till en snurr.',
